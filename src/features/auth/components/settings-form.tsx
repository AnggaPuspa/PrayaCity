    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl">
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden h-fit">
        <div className="px-6 py-4 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
          <h2 className="text-lg font-semibold text-gray-900 m-0">{t("profileTitle")}</h2>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden h-fit">
        <div className="px-6 py-4 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
          <h2 className="text-lg font-semibold text-gray-900 m-0">{t("passwordTitle")}</h2>
        </div>
        ...
        <form onSubmit={handlePasswordSubmit} className="p-6">
          ...
          <div className="mb-5">
            <label className="block text-sm font-semibold text-gray-700 mb-1.5">{t("currentPassword")}</label>
            <input
              type="password"
