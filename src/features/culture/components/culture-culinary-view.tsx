      ...
      <div className="container mx-auto px-6 md:px-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8">
          ...
          <div className="md:col-span-6 flex flex-col gap-6 lg:gap-8">
            {items[0] && <CulinaryCard item={items[0]} />}
            {items[1] && <CulinaryCard item={items[1]} />}
          ...
          <div className="md:col-span-6 flex flex-col gap-6 lg:gap-8">
            ...
            {items[2] && <CulinaryCard item={items[2]} />}
            {items[3] && <CulinaryCard item={items[3]} />}
          </div>
...
function CulinaryCard({ item }: { item: CulinaryItem }) {
  return (
    <Link
      href={item.href}
      className="bg-white rounded-[24px] p-4 flex flex-col w-full shadow-sm transition-shadow hover:shadow-md"
    >
